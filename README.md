...
If you are planning to use this to connect to remote linux sessions you should consider disabling compositing on your desktop. The best performance is achieved with kde with compositing and visual effects disabled.

Always install and enable(start) the **spice-vdagent** and **xorg-qxl-driver** on the guest VM OS to get the best results and to have custom resolutions etc.
